...
```{r, eval = eval_all, fig.width=4, fig.height=4}
vpc(sim, obs,
    vpc_theme = vpc_theme (update = list(
       sim_pi_fill = "#666666", sim_pi_alpha = 0.1,
       sim_median_fill = "#666666", sim_median_alpha = 0.3))
)
```
...
```{r, eval = eval_all}
obs_cat <- read_table_nm(file="~/git/vpc/nm/sdtab45")
sim_cat <- read_table_nm(file="~/git/vpc/nm/simtab45")
vpc_cat (sim = sim_cat, obs = obs_cat, nonmem = TRUE, 
